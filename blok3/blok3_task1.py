...
def test_on_mid_data(count): #функция, тестирующая средний случай (неотсортированный набор случайных данных)
    with open("test_input.txt", 'w') as f:
        ...
        for i in range(count):
            ...
            number = random.randint(10 ** 9 - count, 10 ** 9)
...
# test_on_big_data(1000) заняло 0.01177 секунд и использовало 0.007404 МБ памяти
# test_on_big_data(10000) заняло 0.15237 секунд и использовало 0.009469 МБ памяти
# test_on_big_data(100000) заняло 1.79261 секунд и использовало 0.010813 МБ памяти

# test_on_good_data(1000) заняло 0.01516 секунд и использовало 0.007548 МБ памяти
# test_on_good_data(10000) заняло 0.015589 секунд и использовало 0.009613 МБ памяти
#test_on_good_data(100000) заняло 1.78764 секунд и использовало 0.010957 МБ памяти

# test_on_mid_data(1000) заняло 0.01324 секунд и использовало 0.010361 МБ памяти
# test_on_mid_data(10000) заняло 0.17028 секунд и использовало 0.013606 МБ памяти
# test_on_mid_data(100000) заняло 1.97642 секунд и использовало 0.014950 МБ памяти
