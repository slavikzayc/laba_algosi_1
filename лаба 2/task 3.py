# вся идея алгоритма: разбить массив на группы из эл-ов с разницей k по индексам, отсортировать эти группы,
#соединить все группы и посмотреть отсортирован ли массив, если не отсортирован - задача не решаема.
